...
Make sure you have an SSH key configured on your local machine. 
...
<Info>
When starting AWS servers, you may see a 504 or 524 error. This is an issue we'll fix, but it doesn't affect the server startup.
</Info>
...
Select the instance you want to connect to, then select the Jupyter Session you want to connect to.